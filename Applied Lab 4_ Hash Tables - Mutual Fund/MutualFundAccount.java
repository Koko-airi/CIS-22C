...
public class MutualFundAccount {
    ...
    public void deductFee() {
        double total = mf.getPricePerShare() * numShares * mf.getTradingFee();
        numShares -= total/mf.getPricePerShare();
    }
    ...
    public String toString() {
        ...
        sb.append("\n\nTotal Shares: " + numShares);
        sb.append(String.format("\nValue: $%,.2f", numShares * mf.getPricePerShare()) + "\n");
        return sb.toString();
    }
...
class ValueComparator implements Comparator<MutualFundAccount> {
    ...
    @Override
    public int compare(MutualFundAccount account1, MutualFundAccount account2) {
        return (int) (account1.getNumShares() * account1.getMf().getPricePerShare() -
                account2.getNumShares() * account2.getMf().getPricePerShare());
    }
}
