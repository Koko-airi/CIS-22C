...
public class Card implements Comparable<Card> {
    ...
    public boolean equals(Object obj) {
        ...
        return rank.equals(otherCard.getRank()) && suit.equals(otherCard.getSuit());
    ...
    public int compareTo(Card card) {
        String value = "2345678910JQKA";

        return (suit.compareTo(card.suit) == 0)
                ? ((Integer)value.indexOf(rank)).compareTo(value.indexOf(card.rank)) : suit.compareTo(card.suit);
    }
}
